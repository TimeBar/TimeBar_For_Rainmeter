;=========================================================================================================================================================
; RainRGB.exe is Copyright 2101 by Jeffrey Morley
...
;
; RainRGB.exe MUST reside in [RainmeterProgramDir]Addons\RainRGB
;
; Usage:
...
; This is the name of the Rainmeter config (ex: Enigma\Sidebar) you wish to refresh after the variable has been set.
